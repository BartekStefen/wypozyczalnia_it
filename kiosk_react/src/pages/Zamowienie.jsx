...
const CSS = `
  ...
  .zam-input[readOnly] { background: #f8fafc; color: #64748b; }
  ...
  .zam-btn:hover:not(:disabled) { background: linear-gradient(135deg, #1d4ed8, #1e40af); transform: translateY(-2px); }
...
export default function Zamowienie() {
  ...
  // Dane formularza - auto-wypełniane z konta
  ...
  // Auto-wypełnienie z danych zalogowanego użytkownika
  useEffect(() => {
  ...
  const handleFinalize = async (e) => {
    ...
    try {
      ...
      // Gość musi podać dane klienta; zalogowany nie musi
      if (!czyZalogowany) {
    ...
    <div className="zam-wrap">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 380px', gap: '2rem', alignItems: 'start' }}>
        ...
        <div className="zam-card">
          <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: '1.4rem', fontWeight: 800, color: '#0f172a', margin: '0 0 0.25rem' }}>
          ...
          {error && <div className="zam-error">{error}</div>}
          ...
          <form onSubmit={handleFinalize}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem 1.25rem', marginBottom: '1.5rem' }}>
              <div>
